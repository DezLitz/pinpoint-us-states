...
install:
	...
	go install github.com/deslittle/pinpoint/cmd/geojson2locpb@v0.3.0
	go install github.com/deslittle/pinpoint/cmd/reducelocpb@v0.3.0
	go install github.com/deslittle/pinpoint/cmd/compresslocpb@v0.3.0
	go install github.com/deslittle/pinpoint/cmd/preindexlocpb@v0.3.0
	go install github.com/deslittle/pinpoint/cmd/preindexlocpb@v0.3.0
